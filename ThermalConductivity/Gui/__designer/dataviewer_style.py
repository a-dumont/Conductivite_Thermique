...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButton_comparisonRemove = QtWidgets.QPushButton(self.widget_4)
        self.pushButton_comparisonRemove.setObjectName("pushButton_comparisonRemove")
        self.verticalLayout_8.addWidget(self.pushButton_comparisonRemove)
        ...
        self.pushButton_ComparisonAddFile = QtWidgets.QPushButton(self.widget_3)
        self.pushButton_ComparisonAddFile.setObjectName("pushButton_ComparisonAddFile")
        self.verticalLayout.addWidget(self.pushButton_ComparisonAddFile)
        self.pushButton_comparisonAddAnalysis = QtWidgets.QPushButton(self.widget_3)
        self.pushButton_comparisonAddAnalysis.setObjectName("pushButton_comparisonAddAnalysis")
        self.verticalLayout.addWidget(self.pushButton_comparisonAddAnalysis)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_comparisonRemove.setText(_translate("MainWindow", "Remove Measurement"))
        self.label_8.setText(_translate("MainWindow", "Dataset"))
        self.label_5.setText(_translate("MainWindow", "x-axis"))
        self.pushButton_ComparisonAddFile.setText(_translate("MainWindow", "Add Measurement from file"))
        self.pushButton_comparisonAddAnalysis.setText(_translate("MainWindow", "Add Measurement from Analysis"))
